...
function renderWritings(){
  ...
  [...list].reverse().forEach(item=>{
    ...
    card.innerHTML = `
      ...
      ${item.body ? `<div class="submit-body" id="${bodyId}">${escapeHtml(item.body)}</div><button class="read-more-btn" id="${btnId}" onclick="toggleReadMore('${bodyId}','${btnId}')">Read more ↓</button>` : ''}
